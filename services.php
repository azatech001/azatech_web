      ...
      <article class="col1">
        ...
        <div class="pad_left1 pad_bot1">
          <div class="wrapper img1">
            ...
            <p class="pad_top2"><strong>Sed ut perspiciatis unde omnis</strong><br>
              Lste naerror voluptatem accusantium doloremque ab illo inventore veritatis et quasi architecto laudantium, totam rem aperiam, eaque ipsaquae beatae vitae dicta sunt explic.</p>
          </div>
          <div class="pad"> <strong>Abomo enim ipsam voluptatem</strong> quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos:
            <div class="wrapper">
              <div class="cols">
                <ul class="list2">
                  <li><a href="#">Dqui ratione voluptatem</a></li>
                  ...
                  <li><a href="#">Sed quia non numquam eius </a></li>
                </ul>
              </div>
              <div class="cols pad_left2">
                <ul class="list2">
                  <li><a href="#">Modi tempora incidunt ut</a></li>
                  <li><a href="#">Labore et dolore magnam</a></li>
                  <li><a href="#">Aliquam quaerat voluptatem</a></li>
                  <li><a href="#">Ut enim minima veniam</a></li>
                  <li><a href="#">Quis nostrum exercitationem </a></li>
                </ul>
              </div>
            </div>
            <p><strong>Sed ut perspiciatis unde omnis iste natus error</strong> voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit.</p>
          </div>
        </div>
        ...
        <div class="pad_left1">
          <div class="wrapper">
            <div class="col3">
              <figure><img src="images/page2_img2.png" alt=""></figure>
              <p class="pad"><strong class="font1">William Johnson Jr.</strong><br>
                <span class="font2">Production Manager</span><br>
                Modi teincidunt aliquam quaerat enim ad minima veniam, nostkkrum exercitationem ullam.</p>
            </div>
            <div class="col3 pad_left1">
              <figure><img src="images/page2_img3.png" alt=""></figure>
              <p class="pad"><strong class="font1">Kirsten Jankins</strong><br>
                <span class="font2">Lawyer</span><br>
                Corporis suscipit laboriosam, nisi<br>
                ut aliquid ex ea commodi consequaturuis autem veleum.</p>
            </div>
          </div>
        </div>
      </article>
